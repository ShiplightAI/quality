  ...
  switch (input.code) {
    ...
    case "MISSING_OBSERVATION_ARTIFACT_MATCH":
      return {
        ...
        explanation:
          "Quality Explorer selected a runtime observation source, but the selected run or folder did not contain the canonical quality-observations file named by observation_path.",
        recommendedAction:
